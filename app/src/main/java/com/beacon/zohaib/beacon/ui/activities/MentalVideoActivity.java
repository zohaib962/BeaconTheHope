...
public class MentalVideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mental_video);
        ...
        BT_Back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent I = new Intent(MentalVideoActivity.this,MentalActivity.class);
                startActivity(I);
            }
        });
    ...
    private class ActivityEventListener extends VrVideoEventListener {
        ...
        public void onLoadError(String errorMessage) {
            ...
            Toast.makeText(
                    MentalVideoActivity.this, "Error loading video: " + errorMessage, Toast.LENGTH_LONG)
                    .show();
        ...
        protected Boolean doInBackground(Pair<Uri, VrVideoView.Options>... fileInformation) {
            try {
                if (fileInformation == null || fileInformation.length < 1
                    ...
                    videoWidgetView.loadVideoFromAsset("vr.mp4", options);
                } else {
                ...
                videoWidgetView.post(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(MentalVideoActivity.this, "Error opening file. ", Toast.LENGTH_LONG).show();
                    }
                });
